...
<body>
    ...
    <header class="header text-center position-fixed z-3 w-100">
        <nav class="navbar navbar-expand-lg d-flex justify-content-end navbar-dark">
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navigation" aria-controls="navigation" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div id="navigation" class="collapse navbar-collapse flex-row">
                <a href="/index.php">
                    <img class="mb-3 mx-5 logo d-none d-lg-block" src="images/logo.png" alt="logo">
                </a>
                ...
                <ul class="social-list list-inline py-2 mx-5 justify-content-center">
                    ...
                    <script>
                        resyWidget.addButton(document.getElementById('resyButton-x-sn33RhJzxlfc_rRX9qM'), {
                            "venueId": 77601,
                            "apiKey": "RMHUJo22fkKQwGlWEJ8QqkbzkuvUvyEn",
                            "replace": true
                        });
                    </script>
                </ul>
